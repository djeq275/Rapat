...
class TelegramSettingsControllerTest {
    ...
    void customRoleWithMatchingCapabilityCanAccess() throws Exception {
        ...
        mockMvc.perform(get("/admin/telegram/settings").with(user("manajer@company.local")
                        .authorities(new SimpleGrantedAuthority("CAPABILITY_MANAGE_TELEGRAM_BOT_CONFIG"))))
